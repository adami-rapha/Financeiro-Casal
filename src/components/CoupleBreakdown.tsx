            ...
            <div className="ring-card-body">
                ...
                <div className="rings-wrapper">
                    <svg viewBox="-10 -10 120 120" className="rings-svg">
                        <defs>
                            <linearGradient id="grad-both" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="var(--couple-color)" />
                                <stop offset="100%" stopColor="var(--couple-color)" stopOpacity="0.5" />
                            </linearGradient>
                            <linearGradient id="grad-me" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="var(--person1-color)" />
                                <stop offset="100%" stopColor="var(--person1-color)" stopOpacity="0.5" />
                            </linearGradient>
                            <linearGradient id="grad-her" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="var(--person2-color)" />
                                <stop offset="100%" stopColor="var(--person2-color)" stopOpacity="0.5" />
                            </linearGradient>
                        ...
                        <path className="ring-val both" filter="url(#volumetric)" stroke="url(#grad-both)" pathLength="100" strokeDasharray="100" strokeDashoffset={offsetBoth} style={{ strokeWidth: 8 }} d="M 50 25 C 50 25 45 10 25 10 C 5 10 5 35 5 35 C 5 60 50 90 50 90 C 50 90 95 60 95 35 C 95 35 95 10 75 10 C 55 10 50 25 50 25 Z" />
                        <path className="ring-val me" filter="url(#volumetric)" stroke="url(#grad-me)" pathLength="100" strokeDasharray="100" strokeDashoffset={offsetMe} style={{ strokeWidth: 8 }} d="M 50 30.6 C 50 30.6 46.4 19.8 32 19.8 C 17.6 19.8 17.6 37.8 17.6 37.8 C 17.6 55.8 50 77.4 50 77.4 C 50 77.4 82.4 55.8 82.4 37.8 C 82.4 37.8 82.4 19.8 68 19.8 C 53.6 19.8 50 30.6 50 30.6 Z" />
                    ...
                    <div className="rings-center-icon">
                        <i className="fa-solid fa-rings-wedding" style={{ fontSize: 20, background: "var(--couple-gradient)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.5))" }}></i>
                    </div>
                </div>

                {/* Stats Column */}
                <div className="ring-stats-col">
                    <div className="ring-stat-block purple">
                        <div className="ring-stat-dot" style={{ background: "var(--couple-gradient)" }}></div>
                    ...
                    <div className="ring-stat-block blue">
                        <div className="ring-stat-dot" style={{ background: "var(--person1-gradient)" }}></div>
                        <div className="ring-stat-info">
                            <span className="ring-stat-label">Meus Gastos (Ele)</span>
                    ...
                    <div className="ring-stat-block pink">
                        <div className="ring-stat-dot" style={{ background: "var(--person2-gradient)" }}></div>
                        <div className="ring-stat-info">
